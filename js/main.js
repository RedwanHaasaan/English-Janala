...
const displayWords = (wordList) => {
    ...
    if(wordList.length>0)
    {
        for(let word of wordList)
        {
            ...
            wordDiv.innerHTML =`
                    <div class="bg-white rounded-xl text-center flex flex-col gap-6 sm:gap-8 p-6 sm:p-10 lg:p-14 w-full max-w-md mx-auto">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <!-- Volume -->
                            <button class="w-10 h-10 sm:w-12 sm:h-12 bg-sky-100 rounded-xl flex items-center justify-center cursor-pointer hover:bg-sky-200 transition">
                                <i class="fa-solid fa-volume-high text-slate-600 text-sm sm:text-base"></i>
                            </button>
                        </div>
                    </div>
            `;
            ...
            const wordDiv=document.createElement("div");
            wordDiv.classList="col-span-full flex flex-col justify-center items-center text-center max-w-md mx-auto gap-4"
            wordDiv.innerHTML =`
